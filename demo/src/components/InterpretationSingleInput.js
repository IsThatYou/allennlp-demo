      ...
      <div>
       <AccordionItem expanded={true}>
          ...
          <AccordionItemBody>
            ...
            {tokensWithWeights.length !== 0 ? <div>{token_color_map} <Tooltip /> <input type="range" min={0} max={token_color_map.length} step="1" value={this.state.topK} className="slider" onChange={this.handleTopKChange} style={{ padding: "0px", margin: "0px" }} /> <br /><br /></div> : <p style={{color: "#7c7c7c"}}>Press "interpret prediction" to show the interpretation.</p>}
