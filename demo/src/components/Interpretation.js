      ...
      <div>
       <AccordionItem expanded={true}>
          ...
          <AccordionItemBody>
            ...
            onChange={this.handleHypoTopKChange} style={{ padding: "0px", margin: "0px" }} /> <br /> <span style={{ color: "#72BCFF" }}>Visualizing the top {this.state.hypotopK} words.</span> <br /><br /></div> : <p></p>}
